...
"[project]/src/app/dashboard/requests/api/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const filePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), "src", "app", "data", "requests.txt");
/* ---------------- HELPERS ---------------- */ const readRequests = ()=>{
...
const writeRequests = (requests)=>{
    __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].writeFileSync(filePath, JSON.stringify(requests, null, 2));
};
async function GET() {
    const requests = readRequests();
    // Filter out deleted requests (where deletedAt is set)
    const activeRequests = requests.filter((r)=>!r.deletedAt);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(activeRequests);
}
async function POST(request) {
    ...
    try {
        ...
        const newRequest = {
            ...
            ...Object.fromEntries(Object.entries(optionalFields).map(([k, v])=>[
                    k,
                    String(v)
                ]))
        };
...
async function PUT(request) {
    ...
    if (!updatedRequest.id || !updatedRequest.category || !updatedRequest.title || !updatedRequest.description) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            message: "Missing required fields"
        }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b1a77135._.js.map